...
class TestGame(unittest.TestCase):
    ...
    def test1(self):
        '''Test case for an edge case with no solutions'''
        grid = maze.Maze(5, 5)
        grid._set_maze([["*", "*",   1, "*", "*"],
                        ["*", "*", "*", "*", "*"],
                        ["*", "*", "*", "*", "*"],
    ...
    def test3(self):
        '''Test case for a 4x4 maze'''
        grid = maze.Maze(4, 4)
        grid._set_maze([[  4,   5,   5,   4],
                        [  3, "*", "*",   3],
                        [  2, "*", "*",   2],
                        [  1, "*", "*",   1]])
        start = (3,0)
        ...
        self.assertEqual(path, [(3, 0), (2, 0), (1, 0), (0, 0), (0, 1), (0, 2), (0, 3), (1, 3), (2, 3), (3, 3)])
